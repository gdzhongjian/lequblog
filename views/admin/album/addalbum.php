                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                'action'=>Url::toRoute('admin/album/check-add-album')
                                ]) ?>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">相册名称</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input1" required="" placeholder="相册名称" name="name" value=""/>
                                    </div>
                                </div>
                                <hr />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label><input type="radio" name="status" value="1"/>不显示</label>    
                                    </div>
                                </div>
                                <hr />
