    ...
    <section id="error-container">
        ...
        <div class="block-error">
            ...
            <div class="row">
                <?php if ($login==true) {?>
                    <div class="col-md-12">
                    <a class="btn btn-info btn-block btn-3d" href="<?=Url::toRoute('admin/login/index') ?>">马上登录</a>
                    </div>
                <?php }else { ?>
                <div class="col-md-12">
                    <a class="btn btn-info btn-block btn-3d" href="<?=Url::toRoute('admin/register/index') ?>">返回注册</a>
                </div>
                <?php } ?>
            </div>
        </div>
