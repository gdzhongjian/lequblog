					...
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<form action="<?=Url::toRoute('admin/said/check-edit-said') ?>" method="post" class="form-horizontal form-border" id="form" />
								<input name="id" value="<?=$said['id'] ?>" type="hidden" />
								<div class="form-group">
                                    <label class="col-sm-2 control-label">说说标题</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="input1" required="" name="title" value="<?=$said['title'] ?>" />
                                    </div>
                                </div>
								<div class="form-group">
									<label class="col-sm-2 control-label">说说正文</label>
									<div class="col-sm-8">
										<script id="editor" name="content" style="width:100%;height:300px;">
										<?=$said['content'] ?>
										</script>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label>
											<input type="radio" name="type" value="0" <?php if($said['type']==0) echo "checked";?>  />显示</label>
										<label>
											<input type="radio" name="type" value="1" <?php if($said->type!=0) echo "checked";?> />不显示</label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label>
											<input type="radio" name="istop" value="0" <?php if($said->istop==0) echo "checked"; ?> />不置顶</label>
										<label>
											<input type="radio" name="istop" value="1" <?php if($said->istop!=0) echo "checked";?> />置顶</label>
									</div>
								</div>
								...
								<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"  class="form-control" name="hits" value="<?=$said['hits'] ?>"/ readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group">
								...
								<div class="form-group">
                                        <div class="col-sm-offset-3 ">
                                            <button type="submit" class="btn btn-primary">修改说说</button>
                                        </div>
                                    </div>
								</form>
							</div>
