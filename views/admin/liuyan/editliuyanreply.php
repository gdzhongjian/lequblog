            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?=Url::toRoute('admin/liuyan/check-edit-liuyan-reply') ?>" name="basic_validate" id="signupForm">                           
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <script type="text/plain" id="editor" name="content" style="width:78%;height:200px;"><?=$guestbook_reply['author_reply'] ?></script>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
