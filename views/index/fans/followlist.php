								...
								<div class="clearfix articlebox">
									...
									<a href="<?=Url::toRoute(['index/index/index','uid'=>$follow->follow_uid]) ?>" title="" target="_blank">
										...
										<div class="liuyan_t">
											...
											<a href="<?=Url::toRoute(['index/index/index','uid'=>$follow->follow_uid]) ?>" target="_blank"><?=$follow->follow ?></a>
											&nbsp;&nbsp;</span>
										...
										<div class="liuyan_c">
										<input type="hidden" name="beiguanzhuid" id="beiguanzhuid" value="<?=$follow->follow_uid ?>">
